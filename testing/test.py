...
#     """
#     def setUp(self):
#         self.input_image = os.path.abspath(test_image_path)
#         self.output_directory = os.path.join(parent_dir, "static", "output")
#         self.bg_color = test_bg_color
#         self.brightness = 20
#         self.contrast = 100
...
#         img_contrast = image_utils.adjust_contrast(img_brightness, self.contrast)
...
class TestFlaskApp(unittest.TestCase):
    ...
    def test_process(self):
        ...
        response = self.client.post('/process', content_type='multipart/form-data', data={
            'image': (test_image, test_image_path),
